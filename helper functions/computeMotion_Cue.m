...
halfNumDots = floor(numDots/2);

trialAngle_AllDots = zeros(numDots,1);
switch cueType
    case 0 %neutral
        trialAngle_AllDots(1:halfNumDots) =  repmat(baseAngle,length(1:halfNumDots),1);
        trialAngle_AllDots(halfNumDots:end) =  repmat(180+baseAngle,length(trialAngle_AllDots(halfNumDots:end)),1);
    case 1 %valid
