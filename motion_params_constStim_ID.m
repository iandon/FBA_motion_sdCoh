function params = motion_params_constStim_ID()
...
stim.sdVals = [.1, 2, logspace(log10(4),log10(180),8)];
...
%      Trial params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trial = struct('numTrialsPerBlock', {120}); %total number of trials in a blocks
...
%      Save Data params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
save = struct('fileName', {'motionExp'}, 'expTypeDirName', {'EstiDisc'}, 'SubjectInitials',{'ID'});
...
%     ISI params
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ISI = struct('postDur', {0.05},'preDur',{.100}); %'preOrder',2,)
% 
% switch ISI.preOrder
%     case 1
